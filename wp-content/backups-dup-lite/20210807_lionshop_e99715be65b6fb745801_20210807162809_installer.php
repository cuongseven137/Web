...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210807_lionshop_e99715be65b6fb745801_20210807162809_archive.zip';
	const ARCHIVE_SIZE		 = '70794980';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'e99715b-07162809';
    const SECONDARY_PACKAGE_HASH = '7f0fa85-07162809';
	const VERSION			 = '1.4.2';
